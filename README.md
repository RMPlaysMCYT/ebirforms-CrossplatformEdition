# eBIRForms Cross Platform Edition
Make Philippines eBIRFORMS available on Windows, Mac and Linux

This project was desktop application based where it serves it's purpose but it's expanded to MacOS and Linux also as the original and official version was made exclusively for Windows
...
<br/>source: https://www.bir.gov.ph/ebirforms

## Framework used
* Avalonia 12
* .Net 10 (Backwards Compatible for 9.0 and 8.0)